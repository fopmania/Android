...
public class CustomKeyboard2 {
    ...
    public CustomKeyboard2(Activity activity) {
        mActivity = activity;
...
//        ViewGroup keyboardContainer = (ViewGroup) activity.findViewById(R.id.flKeyboard);
        ViewGroup keyboardContainer = (ViewGroup) activity.findViewById(R.id.keyboardview);
